...
export abstract class DxPagerPageNumberViewBase
  extends DxViewBase<PageNumberAngularVM, DxPagerPageNumberActions> {
}
...
export class DxPagerPageNumberViewComponent extends DxPagerPageNumberViewBase {
