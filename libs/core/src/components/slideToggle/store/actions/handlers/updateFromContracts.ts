...
import {Action, ActionHandler} from '../../../../../internal';
...
const updateFromContractsHandler: ActionHandler<SlideToggleActions, SlideToggleState> =
  (state: DeepReadonly<SlideToggleState>, action: Action<SlideToggleActions>): DeepReadonly<SlideToggleState> => {
